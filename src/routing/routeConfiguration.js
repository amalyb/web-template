...
const TopLendersPage = loadable(() => import(/* webpackChunkName: "TopLendersPage" */ '../containers/TopLendersPage/TopLendersPage'));
...
const ShipPage = loadable(() => import(/* webpackChunkName: "ShipPage" */ '../containers/ShipPage/ShipPage'));
...
const routeConfiguration = (layoutConfig, accessControlConfig) => {
  ...
  return [
    ...
    },
    {
      path: '/return/:id',
      name: 'ReturnPage',
      component: ShipPage, // Reuse ShipPage for return labels
    },
    {
      path: '/listings',
